...
Last Updated: `2026-07-24 17:40:32 UTC`

## 📊 Live DNS Status Table

| Server | Type | Address | Status | Speed (ms) | Ad-Block | Malware-Block |
| :--- | :--- | :--- | :---: | :---: | :---: | :---: |
| Cloudflare (Secondary) | `standard` | `1.0.0.1` | ✅ | 31 | ❌ | ❌ |
| CleanBrowsing (Security) | `filtering` | `185.228.168.9` | ✅ | 31 | ❌ | ❌ |
| CleanBrowsing (Family) | `filtering` | `185.228.168.168` | ✅ | 31 | ❌ | ❌ |
| Verisign | `standard` | `64.6.64.6` | ✅ | 31 | ❌ | ❌ |
| Verisign (Secondary) | `standard` | `64.6.65.6` | ✅ | 31 | ❌ | ❌ |
| Control D (Unfiltered) | `standard` | `76.76.2.0` | ✅ | 31 | ❌ | ❌ |
| Google (Secondary) | `standard` | `8.8.4.4` | ✅ | 32 | ❌ | ❌ |
| OpenDNS | `standard` | `208.67.222.222` | ✅ | 32 | ❌ | ❌ |
| OpenDNS (Secondary) | `standard` | `208.67.220.220` | ✅ | 32 | ❌ | ❌ |
| OpenDNS (FamilyShield) | `filtering` | `208.67.222.123` | ✅ | 32 | ❌ | ❌ |
| Quad9 | `filtering` | `9.9.9.9` | ✅ | 32 | ❌ | ❌ |
| Comodo Secure DNS | `filtering` | `8.26.56.26` | ✅ | 32 | ❌ | ❌ |
| Control D (Unfiltered Sec) | `standard` | `76.76.10.0` | ✅ | 32 | ❌ | ❌ |
| Cloudflare | `standard` | `1.1.1.1` | ✅ | 33 | ❌ | ❌ |
| Cloudflare (Malware Block) | `filtering` | `1.1.1.2` | ✅ | 33 | ❌ | ✅ |
| Cloudflare (Family) | `filtering` | `1.1.1.3` | ✅ | 33 | ❌ | ✅ |
| Google | `standard` | `8.8.8.8` | ✅ | 37 | ❌ | ❌ |
| Neustar | `standard` | `156.154.70.1` | ✅ | 38 | ❌ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 50 | ✅ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 54 | ✅ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 161 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 186 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 186 | ❌ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 412 | ❌ | ❌ |
