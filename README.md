...
Last Updated: `2026-09-22 19:37:47 UTC`
...
| Cloudflare (Secondary) | `standard` | `1.0.0.1` | ✅ | 24 | ❌ | ❌ |
| CleanBrowsing (Security) | `filtering` | `185.228.168.9` | ✅ | 25 | ❌ | ❌ |
| CleanBrowsing (Family) | `filtering` | `185.228.168.168` | ✅ | 25 | ❌ | ❌ |
| Verisign (Secondary) | `standard` | `64.6.65.6` | ✅ | 26 | ❌ | ❌ |
| Cloudflare (Family) | `filtering` | `1.1.1.3` | ✅ | 27 | ❌ | ✅ |
| Cloudflare (Malware Block) | `filtering` | `1.1.1.2` | ✅ | 28 | ❌ | ✅ |
| OpenDNS (Secondary) | `standard` | `208.67.220.220` | ✅ | 28 | ❌ | ❌ |
| Google | `standard` | `8.8.8.8` | ✅ | 37 | ❌ | ❌ |
| Google (Secondary) | `standard` | `8.8.4.4` | ✅ | 39 | ❌ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 84 | ✅ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 85 | ✅ | ❌ |
| DNS.WATCH | `standard` | `84.200.69.80` | ✅ | 145 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 195 | ❌ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 201 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 201 | ❌ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 280 | ❌ | ❌ |
