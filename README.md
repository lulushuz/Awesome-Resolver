...
Last Updated: `2026-07-20 06:50:41 UTC`
...
| Cloudflare (Malware Block) | `filtering` | `1.1.1.2` | ✅ | 15 | ❌ | ✅ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 16 | ✅ | ❌ |
| Verisign | `standard` | `64.6.64.6` | ✅ | 17 | ❌ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 18 | ✅ | ❌ |
| Control D (Unfiltered) | `standard` | `76.76.2.0` | ✅ | 18 | ❌ | ❌ |
| Control D (Unfiltered Sec) | `standard` | `76.76.10.0` | ✅ | 18 | ❌ | ❌ |
| Neustar | `standard` | `156.154.70.1` | ✅ | 22 | ❌ | ❌ |
| Cloudflare (Family) | `filtering` | `1.1.1.3` | ✅ | 23 | ❌ | ✅ |
| Google | `standard` | `8.8.8.8` | ✅ | 28 | ❌ | ❌ |
| OpenDNS | `standard` | `208.67.222.222` | ✅ | 45 | ❌ | ❌ |
| OpenDNS (Secondary) | `standard` | `208.67.220.220` | ✅ | 45 | ❌ | ❌ |
| OpenDNS (FamilyShield) | `filtering` | `208.67.222.123` | ✅ | 56 | ❌ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 69 | ❌ | ❌ |
| DNS.WATCH | `standard` | `84.200.69.80` | ✅ | 148 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 204 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 213 | ❌ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 351 | ❌ | ❌ |
