...
Last Updated: `2026-07-16 14:01:37 UTC`
...
| Neustar | `standard` | `156.154.70.1` | ✅ | 4 | ❌ | ❌ |
| Verisign | `standard` | `64.6.64.6` | ✅ | 5 | ❌ | ❌ |
...
| Cloudflare (Secondary) | `standard` | `1.0.0.1` | ✅ | 21 | ❌ | ❌ |
| Cloudflare (Family) | `filtering` | `1.1.1.3` | ✅ | 22 | ❌ | ✅ |
...
| Google (Secondary) | `standard` | `8.8.4.4` | ✅ | 38 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 174 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 176 | ❌ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 223 | ❌ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 247 | ❌ | ❌ |
