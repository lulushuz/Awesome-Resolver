...
| Neustar | `standard` | `156.154.70.1` | ✅ | 14 | ❌ | ❌ |
...
| Cloudflare (Malware Block) | `filtering` | `1.1.1.2` | ✅ | 18 | ❌ | ✅ |
| Control D (Unfiltered Sec) | `standard` | `76.76.10.0` | ✅ | 18 | ❌ | ❌ |
| OpenDNS | `standard` | `208.67.222.222` | ✅ | 21 | ❌ | ❌ |
| OpenDNS (Secondary) | `standard` | `208.67.220.220` | ✅ | 21 | ❌ | ❌ |
| Google (Secondary) | `standard` | `8.8.4.4` | ✅ | 26 | ❌ | ❌ |
| AdGuard DNS | `filtering` | `94.140.14.14` | ✅ | 26 | ✅ | ❌ |
| Comodo Secure DNS | `filtering` | `8.26.56.26` | ✅ | 30 | ❌ | ❌ |
| Quad9 | `filtering` | `9.9.9.9` | ✅ | 32 | ❌ | ❌ |
| AdGuard DNS (Family) | `filtering` | `94.140.14.15` | ✅ | 32 | ✅ | ❌ |
| Cloudflare (Family) | `filtering` | `1.1.1.3` | ✅ | 34 | ❌ | ✅ |
| Google | `standard` | `8.8.8.8` | ✅ | 37 | ❌ | ❌ |
| Yandex.DNS (Safe) | `filtering` | `77.88.8.7` | ✅ | 167 | ❌ | ❌ |
| Yandex.DNS | `standard` | `77.88.8.8` | ✅ | 171 | ❌ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 183 | ❌ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 290 | ❌ | ❌ |
