...
Last Updated: `2026-09-09 16:14:03 UTC`
...
| Verisign (Secondary) | `standard` | `64.6.65.6` | ✅ | 32 | ❌ | ❌ |
| OpenDNS (FamilyShield) | `filtering` | `208.67.222.123` | ✅ | 39 | ❌ | ❌ |
| Cloudflare (DoH) | `doh` | `https://cloudflare-dns.com/dns-query` | ✅ | 67 | ❌ | ❌ |
| NextDNS (DoH) | `doh` | `https://dns.nextdns.io/dns-query` | ✅ | 133 | ❌ | ❌ |
